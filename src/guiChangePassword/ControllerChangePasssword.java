...
import javafx.stage.*;
public class ControllerChangePasssword {
 ...
 */
	...
	static protected void handleButtonPress() {
 		//get valid password and then close out of window
		ModelChangePassword.goodPassword = ViewChangePassword.text_Password.getText();
		ViewChangePassword.text_Password.setText(""); //clear input
		((Stage) ViewChangePassword.button_Finish.getScene().getWindow()).hide();
