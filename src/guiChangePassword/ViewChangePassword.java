...
public class ViewChangePassword {
	...
	public static void view (Pane theRoot) {
		double windowWidth = applicationMain.FoundationsMain.WINDOW_WIDTH;
		...
		// modified to make it smaller
		setupTextWidget(text_Password, 10, 30, "Arial", 18, 400, Pos.BASELINE_LEFT, 
				true);
	    ...
	    setupLabelWidget(label_Requirements, 10, 120, "Arial", 16, windowWidth-10, 
	    		Pos.BASELINE_LEFT);
	    
	    setupLabelWidget(label_UpperCase, 30, 150, "Arial", 14, windowWidth-10, 
				Pos.BASELINE_LEFT);

	    setupLabelWidget(label_LowerCase, 30, 180, "Arial", 14, windowWidth-10, 
				Pos.BASELINE_LEFT);
	    
	    setupLabelWidget(label_NumericDigit, 30, 210, "Arial", 14, windowWidth-10, 
				Pos.BASELINE_LEFT);
	    
	    setupLabelWidget(label_SpecialChar, 30, 240, "Arial", 14, windowWidth-10, 
				Pos.BASELINE_LEFT);
	    
	    setupLabelWidget(label_LongEnough, 30, 270, "Arial", 14, windowWidth-10, 
				Pos.BASELINE_LEFT);
	    //set GUI for short enough
	    setupLabelWidget(label_ShortEnough, 30, 300, "Arial", 14, windowWidth-10, 
				Pos.BASELINE_LEFT);
		...
		setupLabelWidget(validPassword, 10, 330, "Arial", 18, windowWidth-150-10, 
				Pos.BASELINE_LEFT);
		
		// Setup the Finish and Save The Password button. Modify to fit button in window
		setupButtonWidget(button_Finish, "Finish and Save The Password", (250)/2,
