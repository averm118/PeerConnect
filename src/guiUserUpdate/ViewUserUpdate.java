...
public class ViewUserUpdate {
	...
	private ViewUserUpdate() {
        ...
        //set up button action for password update
        button_UpdatePassword.setOnAction((_) -> {
    		...
    		guiChangePassword.ViewChangePassword.view(theRoot);		// Create the GUI
    		
    		Scene theScene = new Scene(theRoot, WINDOW_WIDTH, WINDOW_HEIGHT);	// Create the scene
    		
    		stage.setScene(theScene);						// Set the scene on the stage
        ...
        button_UpdateFirstName.setOnAction((_) -> {dialogUpdateFirstName.getEditor().clear();
        ...
        button_UpdateMiddleName.setOnAction((_) -> {dialogUpdateMiddleName.getEditor().clear();
        ...
        button_UpdateLastName.setOnAction((_) -> {dialogUpdateLastName.getEditor().clear();
        ...
        button_UpdateEmailAddress.setOnAction((_) -> {dialogUpdateEmailAddresss.getEditor().clear();
        ...
        //check if first name, last name, and email are filled before returning to home.
        button_ProceedToUserHomePage.setOnAction((_) -> 
        	{
        		...
        		//prevent exit going back to home until require info is field in
        		...
        		//set preferred name to fist name if left blank
