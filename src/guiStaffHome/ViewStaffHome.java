...
public class ViewStaffHome {
	...
	protected static Button button_GoToForum = new Button("Go To Forum");
	protected static Button button_AdminRequests = new Button("Admin Requests");
	protected static Button button_EvaluateDiscussions = new Button("Evaluate Discussions");
	...
	private ViewStaffHome() {
		...
		setupButtonUI(button_GoToForum, "Dialog", 16, 250, Pos.CENTER, 20, 270);
		button_GoToForum.setOnAction((_) -> 
		{ControllerStaffHome.goToStaffForum(); });
		
		setupButtonUI(button_AdminRequests, "Dialog", 16, 250, Pos.CENTER, 300, 270);
		button_AdminRequests.setOnAction((e) -> { ControllerStaffHome.goToAdminRequests(); });
		
		setupButtonUI(button_EvaluateDiscussions, "Dialog", 16, 250, Pos.CENTER, 580, 270);
		button_EvaluateDiscussions.setOnAction((_) -> { ControllerStaffHome.goToEvaluateDiscussions(); });
		...
		// Place all of the widget items into the Root Pane's list of children
         theRootPane.getChildren().addAll(
			...
			button_GoToForum, line_Separator4, button_Logout, button_Quit,button_EvaluateDiscussions, button_AdminRequests);
}
