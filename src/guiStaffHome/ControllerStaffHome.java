...
public class ControllerStaffHome {
	...
	public static void goToStaffForum() {
		guiStaffForum.ViewStaffForum.displayStaffForum(ViewStaffHome.theStage, ViewStaffHome.theUser);
	}
	...
	/**********
	 * <p> Method: goToEvaluateDiscussions() </p>
	 * 
	 */	
	public static void goToEvaluateDiscussions() {
		guiEvaluateDiscussions.ViewEvaluateDiscussions.displayEvaluateDiscussions(
				ViewStaffHome.theStage,
				ViewStaffHome.theUser
		);
	}
	/**********
	 * <p> Method: goToAdminRequests() </p>
	 * 
	 */	
	public static void goToAdminRequests() {
	    guiAdminRequestManagement.ViewAdminRequestManagement.displayAdminRequestManagement(
	            ViewStaffHome.theStage,
	            ViewStaffHome.theUser
	    );
	}
