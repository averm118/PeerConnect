...
public class ControllerUserLogin {
	...
	*/
	 ...
	 * 
	 */	
	public static void doLogin(Stage ts) {
		theStage = ts;
    	...
    	User user = new User(username, password, theDatabase.getCurrentFirstName(), 
    			...
    			theDatabase.getCurrentNewStaff(), theDatabase.getCurrentNewStudent());
		...
		if(firstName == null || firstName.isEmpty() || lastName == null || lastName.isEmpty() || email == null || email.isEmpty() || !passwordValid) {
