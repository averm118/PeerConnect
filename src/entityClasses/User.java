...
public class User {
    ...
    public void setStaffRoleUser(boolean role) {
    	this.staffRole=role;
    }

    
    /*****
     * <p> Method: void setStudentRoleUser(boolean role) </p>
     * 
     * <p> Description: This setter defines the studentRole attribute. </p>
     * 
     * @param role is a boolean that specifies if this user in playing studentRole.
     * 
     */
    // Sets the studentRole user.
    public void setSudentRoleUser(boolean role) {
     ...
     * 
     * <p> Description: This getter returns the value of the studentRole attribute. </p>
     * 
     * @return a String of "TRUE" or "FALSE" based on state of the attribute
	 *
     */
    // Gets the current value of the studentRole attribute.
