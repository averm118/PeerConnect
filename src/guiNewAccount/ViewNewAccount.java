...
public class ViewNewAccount {
 ...
 // new label for displaying username requirements in GUI
	protected static Label label_UserNameRequirements = 
			new Label("Username Requirments:\n"
					+ "* 4-32 characters\n"
					+ "* Must start with a letter (A-Z or a-z)\n"
					+ "* Allowed Characters: A-Z, a-z, 0-9, '_', '-', '.'\n"
					+ "* Last character cannot be a special character '_', '-', '.'");
	// new label for displaying password requirements in GUI
	protected static Label label_PasswordRequirements = 
	...
	*/
	...
	public static void displayNewAccount(Stage ps, String ic) {
    	...
    	theRootPane.getChildren().addAll(label_NewUserCreation, label_NewUserLine, text_Username,
    			text_Password1, text_Password2, button_UserSetup, button_Quit, label_UserNameRequirements, label_PasswordRequirements);    	
	...
	private ViewNewAccount() {
		...
		//Label to display username requirements.
		setupLabelUI(label_UserNameRequirements, "Arial", 14, 520, Pos.BASELINE_LEFT, 50, 305);
		//Label to display password requirements.
		setupLabelUI(label_PasswordRequirements, "Arial", 14, 520, Pos.BASELINE_LEFT, 50, 405);
	}
