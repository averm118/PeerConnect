...
public class ViewFirstAdmin {
	...
	private static Label label_UserNameRequirements = 
	...
	private static Label label_PasswordRequirements = 
	...
	private ViewFirstAdmin() {
		...
		theRootPane.getChildren().addAll(label_ApplicationTitle, label_TitleLine1,
				...
				button_Quit, label_UserNameRequirements, label_PasswordRequirements);
	}
