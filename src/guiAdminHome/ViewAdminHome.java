	...
	*/
	...
	public static void displayAdminHome(Stage ps, User user) {
		...
		label_NumberOfInvitations.setText("Number of outstanding invitations: " + 
				theDatabase.getNumberOfInvitations());// UserUpdate page
	...
	private ViewAdminHome() {
		...
		setupButtonUI(button_AdminRequests, "Dialog", 18, 250, Pos.CENTER, 300, 270);
		button_AdminRequests.setOnAction((e) -> { ControllerAdminHome.manageAdminRequests(); });
