...
public class ControllerStudentHome {
	...
	public static void goToForum() {
		guiForum.ViewForum.displayForum(ViewStudentHome.theStage, ViewStudentHome.theUser);
	}
	...
	public static void goToViewEvaluations() {
		guiViewEvaluations.ViewViewEvaluations.displayViewEvaluations(
