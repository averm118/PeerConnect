...
public class ViewStudentHome {
	...
	protected static Button button_ViewEvaluations = new Button("View Evaluations");
	...
	private ViewStudentHome() {
		...
		{ControllerStudentHome.goToForum(); });
		
		setupButtonUI(button_ViewEvaluations, "Dialog", 16, 250, Pos.CENTER, 300, 270);
		button_ViewEvaluations.setOnAction((_) -> {ControllerStudentHome.goToViewEvaluations(); });
        ...
        theRootPane.getChildren().addAll(
	        ...
	        line_Separator4, button_GoToForum, button_Logout,button_ViewEvaluations, button_Quit);
	}
