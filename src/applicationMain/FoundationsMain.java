...
public class FoundationsMain extends Application {
	...
	**********************************************************************************************/
	...
	public static PostDatabase postDatabase = new PostDatabase();
	public static ReplyDatabase replyDatabase = new ReplyDatabase();
	public static FeedbackDatabase feedbackDatabase = new FeedbackDatabase();
	...
	public void start(Stage theStage) {
		...
		try {
			...
			postDatabase.connectToDatabase();
			replyDatabase.connectToDatabase();
			feedbackDatabase.connectToDatabase();
